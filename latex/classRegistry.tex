...
Description of \hyperlink{classRegistry}{Registry} \hyperlink{classRegistry}{Registry} de les configuracions \begin{DoxyAuthor}{Author}
toni 
\end{DoxyAuthor}
...
This function initializes and load config information app, located in Config.\+json 
